            ...
            : filtered.length === 0
              ...
              : filtered.map(r => (
                <tr key={r.id} className="border-t hover:bg-gray-50">
                  <td className="px-3 py-3 text-brand-700 align-top">{r.category || '—'}</td>
                  <td className="px-3 py-3 align-top">
                    <ul className="text-brand-700 space-y-0.5 leading-tight">
              ...
              return (
                <div key={m.key} className="grid grid-cols-[140px_1fr] items-center gap-3 border-b border-gray-100 pb-1.5">
                  ...
                  <input type="number" step="0.01" min="0" max="100"
                    ...
                    className="border-0 border-b border-gray-200 px-1 py-1 text-sm w-full focus:outline-none focus:border-brand-500"/>
                </div>
              )
            })}
          </div>
