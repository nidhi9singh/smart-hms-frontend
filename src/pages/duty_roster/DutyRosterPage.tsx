              ...
              <tbody className="divide-y divide-gray-50">
                ...
                : entries.map(e => (
                  <tr key={e.id} className="hover:bg-gray-50/50">
                    ...
                    <td className="px-4 py-3 text-teal-600">{e.shift_name || '—'}</td>
                    <td className="px-4 py-3 text-teal-600">{e.department || '—'}</td>
                    <td className="px-4 py-3 text-teal-600">{e.floor || '—'}</td>
                  </tr>
                ))}
              </tbody>
            </table>
            ...
            <tbody className="divide-y divide-gray-50">
              ...
              : shifts.map(s => (
                <tr key={s.id} className="hover:bg-gray-50/50">
                  <td className="px-4 py-3 text-teal-600 font-medium">{s.name}</td>
            ...
            <tbody className="divide-y divide-gray-50">
              ...
              : rosters.map(r => (
                <tr key={r.id} className="hover:bg-gray-50/50">
                  <td className="px-4 py-3 text-teal-600 font-medium">{r.shift_name || '—'}</td>
              ...
              <tbody className="divide-y divide-gray-50">
                ...
                : assigned.map((a, idx) => (
                  <tr key={`${a.staff_id}-${a.roster_id}-${idx}`} className="hover:bg-gray-50/50">
                    ...
                    <td className="px-4 py-3 text-teal-600">{a.department || '—'}</td>
                    <td className="px-4 py-3 text-teal-600">{a.shift_name || '—'}</td>
