        ...
        <div className="grid grid-cols-[100px_1fr_1.4fr] gap-4">
            ...
            {BLOOD_GROUPS.map(g => (
              <button key={g} onClick={() => setBg(g)}
                className={cn('w-full text-left px-3 py-2 text-sm rounded-sm',
                  bg === g ? 'bg-blue-500 text-white' : 'bg-gray-50 text-gray-600 hover:bg-gray-100')}
              >{g}</button>
            ))}
          </aside>
          ...
          <div className="card overflow-hidden p-0">
            <div className="flex items-center justify-between px-3 py-2 bg-blue-50">
              ...
              <button onClick={() => setStockModal(true)} className="px-2 py-1 rounded bg-blue-500 text-white text-xs hover:bg-blue-600">
                <Plus size={12}/>
              </button>
            </div>
          ...
          <div className="card overflow-hidden p-0">
            <div className="flex items-center justify-between px-3 py-2 bg-blue-50">
              ...
              <button onClick={() => setCompModal(true)} className="px-2 py-1 rounded bg-blue-500 text-white text-xs hover:bg-blue-600">
                <Plus size={12}/>
              </button>
            </div>
            <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-50">
              ...
              : donors.map(d => (
                <tr key={d.id} className="hover:bg-gray-50/50">
                  <td className="px-4 py-3 text-teal-600 font-medium">{d.name}</td>
              ...
              <tbody className="divide-y divide-gray-50">
                ...
                : issues.map(i => (
                  <tr key={i.id} className="hover:bg-gray-50/50">
                    <td className="px-3 py-3 text-teal-600 text-xs font-medium">{i.issue_no}</td>
                    ...
                    <td className="px-3 py-3 text-xs text-green-600">${Number(i.paid || 0).toFixed(2)}</td>
            ...
            <tbody className="divide-y divide-gray-50">
              ...
              : comps.map(c => (
                <tr key={c.id} className="hover:bg-gray-50/50">
                  ...
                  <td className="px-4 py-3 text-teal-600">{c.bag_no} ({c.volume_ml} {c.volume_unit})</td>
