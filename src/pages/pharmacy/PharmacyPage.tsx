              ...
              <tbody className="divide-y divide-gray-50">
                ...
                : bills.map((b: any) => (
                  <tr key={b.id} className="hover:bg-gray-50/50">
                    <td className="px-3 py-3"><span className="text-teal-600 font-medium cursor-pointer text-xs">{b.bill_no}</span></td>
                    ...
                    <td className="px-3 py-3 text-green-600">${Number(b.paid_amount||0).toFixed(2)}</td>
                ...
                : medicines.map((m: any) => (
                  <tr key={m.id} className="hover:bg-gray-50/50">
                    ...
                    <td className="px-4 py-3">
                      <span className={cn('font-semibold', m.available_qty < 100 ? 'text-red-500' : 'text-green-600')}>{m.available_qty}</span>
                    </td>
                    <td className="px-4 py-3">
                      <div className="flex gap-1">
              ...
              <tbody className="divide-y divide-gray-50">
                ...
                : purchases.map((p: any) => (
                  <tr key={p.id} className="hover:bg-gray-50/50">
                    <td className="px-4 py-3"><span className="text-teal-600 font-medium text-xs">{p.purchase_no}</span></td>
