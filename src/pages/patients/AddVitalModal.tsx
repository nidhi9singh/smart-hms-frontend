  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/40 flex items-start justify-center pt-16">
      <div className="bg-white rounded-lg shadow-xl w-[920px] max-w-[97vw]">
        <div className="flex items-center justify-between px-5 py-3 bg-[#34ace0] text-white rounded-t-lg">
        ...
        <form onSubmit={(e) => { e.preventDefault(); save.mutate() }} className="p-5">
          ...
          <button type="button" onClick={addRow}
            className="flex items-center gap-1 mt-1 px-3 py-1.5 bg-[#00a8e8] hover:bg-[#0090c7] text-white text-xs font-medium rounded">
            <Plus size={12}/> Add
          </button>

          <div className="flex justify-end pt-4 mt-4 border-t border-gray-100">
            <button type="submit" disabled={save.isPending}
              className="flex items-center gap-1.5 px-5 py-2 bg-[#00a8e8] hover:bg-[#0090c7] text-white text-sm font-medium rounded">
