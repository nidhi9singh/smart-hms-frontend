            ...
            <tbody className="divide-y divide-gray-50">
              ...
              : visitors.map(v => (
                <tr key={v.id} className="hover:bg-gray-50/50">
                  ...
                  <td className="px-4 py-3 text-brand-600">{v.visit_to || '—'}</td>
            ...
            <tbody className="divide-y divide-gray-50">
              ...
              : calls.map(c => (
                <tr key={c.id} className="hover:bg-gray-50/50">
                  ...
                  <td className="px-4 py-3 text-brand-600">{c.call_type || '—'}</td>
                  <td className="px-4 py-3">
                    <div className="flex gap-1">
            ...
            <tbody className="divide-y divide-gray-50">
              ...
              : receives.map(r => (
                <tr key={r.id} className="hover:bg-gray-50/50">
                  <td className="px-4 py-3 text-brand-600 font-medium">{r.from_title}</td>
                  <td className="px-4 py-3 text-brand-600">{r.reference_no || '—'}</td>
                  <td className="px-4 py-3 text-brand-600">{r.to_title || '—'}</td>
                  <td className="px-4 py-3 text-brand-600">{r.address || '—'}</td>
            ...
            <tbody className="divide-y divide-gray-50">
              ...
              : dispatches.map(d => (
                <tr key={d.id} className="hover:bg-gray-50/50">
                  <td className="px-4 py-3 text-brand-600 font-medium">{d.to_title}</td>
                  <td className="px-4 py-3 text-brand-600">{d.reference_no || '—'}</td>
                  <td className="px-4 py-3 text-brand-600">{d.from_title || '—'}</td>
        ...
        {tab === 'complaints' && (
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-50">
              ...
              : complaints.map(c => (
                <tr key={c.id} className="hover:bg-gray-50/50">
                  <td className="px-4 py-3 text-brand-600">#{c.id}</td>
                  <td className="px-4 py-3 text-brand-600">{c.complain_type || '—'}</td>
                  <td className="px-4 py-3 text-brand-600">{c.source || '—'}</td>
                  <td className="px-4 py-3 text-brand-600">{c.complainant}</td>
                  <td className="px-4 py-3 text-gray-500">{c.phone || '—'}</td>
