              ...
              <tbody>
                {pagesLoading ? (
                  ...
                  <tr key={p.id} className="border-t hover:bg-gray-50">
                    ...
                    <td className="px-3 py-2 text-brand-600 truncate max-w-md" title={p.url}>{p.url}</td>
                    <td className="px-3 py-2">
                      <span className="text-xs px-2 py-0.5 bg-gray-100 text-gray-700 rounded">{p.page_type}</span>
                    </td>
                    <td className="px-3 py-2 text-right">
                      <div className="flex items-center justify-end gap-1">
                        <button onClick={() => setAddOpen({ open: true, page: p })} className="p-1 hover:bg-brand-50 rounded text-brand-600"><Edit2 size={14}/></button>
                ...
                return (
                  <>
                    <tr key={g.id} className="border-t hover:bg-gray-50">
                      ...
                      <td className="px-3 py-2 text-right">
                        <div className="flex items-center justify-end gap-1">
                          <button onClick={() => setMenuModal({ open: true, group: g })} className="p-1 hover:bg-brand-50 rounded text-brand-600"><Edit2 size={14}/></button>
                ...
                {banners.map(b => (
                  <div key={b.id} className="border rounded overflow-hidden group">
                    ...
                    <div className="p-2 flex items-center justify-between gap-1">
                      <span className="text-xs text-brand-600 truncate" title={b.title}>{b.title}</span>
                      <button
