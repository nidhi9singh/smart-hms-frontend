...
function mediaIcon(t: string | null | undefined) {
  ...
  if (['jpg','jpeg','png','gif','webp','bmp'].includes(x)) return <FileImage size={20} className="text-blue-500"/>
                  ...
                  <div className="p-2 flex items-center justify-between gap-1">
                    {onSelect ? (
                      <button
                        ...
                        className="text-xs text-teal-600 hover:underline truncate flex-1 text-left"
