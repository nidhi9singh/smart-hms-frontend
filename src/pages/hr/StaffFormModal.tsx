      ...
      <form id="staff-form" onSubmit={handleSubmit(d => mut.mutate(d))} className="space-y-4">
        ...
        <div className="flex items-center gap-4 p-3 bg-gray-50 rounded-xl">
          <div
            ...
            className="w-16 h-16 rounded-xl border-2 border-dashed border-gray-200 flex flex-col items-center justify-center cursor-pointer hover:border-teal-400 hover:bg-teal-50 transition overflow-hidden flex-shrink-0"
          >
            {photoPreview
          ...
          <div>
            ...
            {photoFile && <p className="text-xs text-teal-600 mt-0.5">✓ {photoFile.name}</p>}
          </div>
        </div>
