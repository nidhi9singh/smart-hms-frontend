  ...
  return (
    <div className="p-6 space-y-5">
      ...
      <div className="grid grid-cols-4 gap-3">
        {[
          { label: 'Total Items',     value: items.length,  color: 'bg-brand-50 text-brand-700' },
          { label: 'Stock Entries',   value: stocks.length, color: 'bg-brand-50 text-brand-700' },
          { label: 'Available Units', value: totalStockQty, color: 'bg-brand-50 text-brand-700' },
                ...
                return (
                  <tr key={i.id} className="border-t hover:bg-gray-50">
                    ...
                    <td className="px-3 py-2">
                      {returned ? (
                        <span className="inline-block px-2 py-0.5 text-xs rounded bg-brand-100 text-brand-700">Returned</span>
                      ) : (
                        <button
                  ...
                  <td className="px-3 py-2 text-right">
                    <div className="flex items-center justify-end gap-1">
                      <button
                        ...
                        className="p-1 hover:bg-brand-50 rounded text-brand-600" title="Edit"
